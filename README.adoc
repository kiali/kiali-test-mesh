...
[WARNING]
Deploying the full set of test meshes require a lot of resources on the machine running OpenShift. If you are running on a limited machine (e.g. a laptop) these may not deploy or they may deploy but run poorly.
